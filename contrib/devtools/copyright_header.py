...
EXCLUDE = [
    # auto generated:
    'src/qt/digitalaustraliandollarstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    "The DigitalAustralianDollar developers\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The DigitalAustralianDollar developers'
...
Arguments:
    <base_directory> - The base directory of a digitalaustraliandollar source code repository.
"""
