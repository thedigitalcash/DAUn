...
This document provides guidelines for internationalization of the DigitalAustralianDollar Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to DigitalAustralianDollar network</numerusform>
            <numerusform>%n active connections to DigitalAustralianDollar network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `digitalaustraliandollar_en.ts` remains unchanged.
