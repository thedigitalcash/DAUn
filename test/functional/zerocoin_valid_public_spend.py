...
from fake_stake.base_test import DigitalAustralianDollar_FakeStakeTest

class zDAUValidCoinSpendTest(DigitalAustralianDollar_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zDAUs..." % DENOM_TO_USE)
