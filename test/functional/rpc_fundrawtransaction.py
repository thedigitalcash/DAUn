...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid digitalaustraliandollar address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid digitalaustraliandollar address" in e.error['message'])
