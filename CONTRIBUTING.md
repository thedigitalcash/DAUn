Contributing to DigitalAustralianDollar Core
============================

The DigitalAustralianDollar Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to digitalaustraliandollar-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the digitalaustraliandollar unit tests or QA tests
...
[Translation Process](https://github.com/digitalaustraliandollar-project/digitalaustraliandollar/blob/master/doc/translation_process.md)
...
The following applies to code changes to the DigitalAustralianDollar Core project, and is not to be
confused with overall DigitalAustralianDollar Network Protocol consensus changes.

Whether a pull request is merged into DigitalAustralianDollar Core rests with the project merge
...
Patches that change DigitalAustralianDollar consensus rules are considerably more involved than
...
Where a patchset proposes to change the DigitalAustralianDollar consensus, it must have been
...
The project leader is the release manager for each DigitalAustralianDollar Core release.
