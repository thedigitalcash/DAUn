...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DigitalAustralianDollar server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "DigitalAustralianDollar server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DigitalAustralianDollar features */
        {"digitalaustraliandollar", "listmasternodes", &listmasternodes, true, true, false},
        {"digitalaustraliandollar", "getmasternodecount", &getmasternodecount, true, true, false},
        {"digitalaustraliandollar", "masternodeconnect", &masternodeconnect, true, true, false},
        {"digitalaustraliandollar", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"digitalaustraliandollar", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"digitalaustraliandollar", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"digitalaustraliandollar", "masternodecurrent", &masternodecurrent, true, true, false},
        {"digitalaustraliandollar", "masternodedebug", &masternodedebug, true, true, false},
        {"digitalaustraliandollar", "startmasternode", &startmasternode, true, true, false},
        {"digitalaustraliandollar", "createmasternodekey", &createmasternodekey, true, true, false},
        {"digitalaustraliandollar", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"digitalaustraliandollar", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"digitalaustraliandollar", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"digitalaustraliandollar", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"digitalaustraliandollar", "getmasternodescores", &getmasternodescores, true, true, false},
        {"digitalaustraliandollar", "preparebudget", &preparebudget, true, true, false},
        {"digitalaustraliandollar", "submitbudget", &submitbudget, true, true, false},
        {"digitalaustraliandollar", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"digitalaustraliandollar", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"digitalaustraliandollar", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"digitalaustraliandollar", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"digitalaustraliandollar", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"digitalaustraliandollar", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"digitalaustraliandollar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"digitalaustraliandollar", "checkbudgets", &checkbudgets, true, true, false},
        {"digitalaustraliandollar", "mnsync", &mnsync, true, true, false},
        {"digitalaustraliandollar", "spork", &spork, true, true, false},
        {"digitalaustraliandollar", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdauseed", &getzdauseed, false, false, true},
        {"zerocoin", "setzdauseed", &setzdauseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdau", &searchdzdau, false, false, true},
        {"zerocoin", "dzdaustate", &dzdaustate, false, false, true},
...
{
    return "> digitalaustraliandollar-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22071/\n";
}
