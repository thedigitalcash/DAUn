...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DigitalAustralianDollar Core digitalaustraliandollar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  digitalaustraliandollar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitalaustraliandollar transaction") + "\n" +
                               "  digitalaustraliandollar-tx [options] -create [commands]   " + _("Create hex-encoded digitalaustraliandollar transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded digitalaustraliandollar transaction
