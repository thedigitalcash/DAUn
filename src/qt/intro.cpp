...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DigitalAustralianDollar Core"),
     ...
     * override -datadir in the digitalaustraliandollar.conf file in the default data directory
     * (to be consistent with digitalaustraliandollard behavior)
     */
    if (dataDir != getDefaultDataDirectory())
