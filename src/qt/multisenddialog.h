...
#ifndef DigitalAustralianDollar_QT_MULTISENDDIALOG_H
#define DigitalAustralianDollar_QT_MULTISENDDIALOG_H
...
#endif // DigitalAustralianDollar_QT_MULTISENDDIALOG_H
