...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::DAU);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeDigitalAustralianDollarAmount"))
        SoftSetArg("-anonymizedigitalaustraliandollaramount", settings.value("nAnonymizeDigitalAustralianDollarAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in digitalaustraliandollar.cpp during shotdown to also remove the window positions
