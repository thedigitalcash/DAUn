                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDAUPathCustom = GetArg("-zdaubackuppath", "");
    ...
    if(!strzDAUPathCustom.empty()) {
        ui->wallet_customzdaubackuppath->setText(QString::fromStdString(strzDAUPathCustom));
        ui->wallet_customzdaubackuppath_label->setVisible(true);
        ui->wallet_customzdaubackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDAUPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DigitalAustralianDollar RPC console.") + "<br>" +
