...
#ifndef DigitalAustralianDollar_ZDAUTRACKER_H
#define DigitalAustralianDollar_ZDAUTRACKER_H
...
public:
    CzDAUTracker(std::string strWalletFile);
    ~CzDAUTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzDAUWallet* zDAUWallet = NULL);
...
#endif //DigitalAustralianDollar_ZDAUTRACKER_H
