...
#ifndef DigitalAustralianDollar_ZDAUWALLET_H
#define DigitalAustralianDollar_ZDAUWALLET_H
...
public:
    CzDAUWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZDAU(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZDAU(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //DigitalAustralianDollar_ZDAUWALLET_H
